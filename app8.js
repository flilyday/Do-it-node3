...
router.route('/process/adduser').post(function(req, res){
    console.log('/process/adduser함수 호출됨');
    ...
    addUser(paramId, paramPassword, paramAge, paramName, function(err, addeduser){
        if(err) {
            console.log('에러 발생');
...
var addUser = function(id, name, age, password, callback) {
    ...
    pool.getConnection(function(err, conn){
        ...
        console.log("데이터 베이스의 쓰레드 아이디 : " + conn.threadID);
